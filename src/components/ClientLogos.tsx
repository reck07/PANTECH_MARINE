        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {clients.map((client, index) => (
            <ScrollReveal key={index} delay={index * 50} direction="fade">
              <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 flex items-center justify-center border border-gray-200 h-32 hover:border-primary/30 group transform hover:-translate-y-1">
