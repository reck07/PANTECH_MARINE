...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const successMessage = data.message || 'Thank you for your inquiry. We will contact you soon.'
      setSubmitStatus({ 
        type: 'success', 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                We're available 24/7 to assist with your marine survey needs. Contact us via phone, email, or fill out the form.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:operations@pantechmarine.com" className="text-primary hover:underline">
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
